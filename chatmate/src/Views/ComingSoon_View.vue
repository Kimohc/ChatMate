...
import '/src/app.css'
export default {
  name: 'ComingSoon_View',
  components: {},
  data() {
    return {
      countDownDate: new Date("Jun 6, 2024 16:00:00").getTime(),
      timerCount: '',
  ...
  methods: {
    timer() {
      ...
      setInterval(function () {
        ...
        self.timerCount = days + "d " + hours + "h "
            + minutes + "m " + seconds + "s "
      }, 10)
    }
  },
